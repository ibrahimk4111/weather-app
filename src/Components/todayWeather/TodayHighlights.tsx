...
const TodayHighlights = () => {
  return (
    <>
      ...
      <div className=" bg-custom-color/30 backdrop-blur-sm lg:col-span-8 col-span-12 p-2 rounded-md text-white space-y-3 ">
        ...
        <div className=" grid grid-cols-12 gap-3">
          ...
          <div className=" flex w-full gap-2 bg-custom-color/30 backdrop-blur-sm rounded-md px-3 py-2 lg:col-span-5 sm:col-span-6 col-span-12">
            <div className="w-full flex flex-col justify-between items-center ">
              <WiSunrise size={55}  />
              <span>Sunrise</span>
              <span className=" font-bold md:text-xl ">5:30</span>
            </div>
        ...
        <div className=" md:columns-3 columns-2 space-y-2 gap-1 md:gap-5">
          <div className=" bg-custom-color/30 backdrop-blur-sm rounded-md md:px-3 px-1 py-1 flex justify-between items-center ">
            ...
            <span className=" font-bold md:text-xl ">66</span>
          </div>
          <div className=" bg-custom-color/30 backdrop-blur-sm rounded-md px-3 py-1 flex justify-between items-center ">
            ...
            <span className=" font-bold md:text-xl ">4 km/h</span>
          </div>
          <div className=" bg-custom-color/30 backdrop-blur-sm rounded-md px-3 py-1 flex justify-between items-center ">
            <p className=" flex gap-2 items-center">
              <WiHumidity size={20} />
            ...
            <span className=" font-bold md:text-xl ">88%</span>
          </div>
          <div className=" bg-custom-color/30 backdrop-blur-sm rounded-md px-3 py-1 flex justify-between items-center ">
            <p className=" flex gap-2 items-center">
              <MdVisibility />
            ...
            <span className=" font-bold md:text-xl ">3.1 mi</span>
          </div>
          <div className=" bg-custom-color/30 backdrop-blur-sm rounded-md px-3 py-1 flex justify-between items-center ">
            <p className=" flex gap-2 items-center">
              <FaThermometerEmpty />
            ...
            <span className=" font-bold md:text-xl ">29.69 in</span>
          </div>
          <div className=" bg-custom-color/30 backdrop-blur-sm rounded-md px-3 py-1 flex justify-between items-center ">
            <p className=" flex gap-2 items-center">
              <GiDew />
            ...
            <span className=" font-bold md:text-xl ">75°</span>
          </div>
        </div>
      </div>
    </>
